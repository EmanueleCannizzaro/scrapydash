...
BROWSER <<<>>> SCRAPYDASH_BIND:SCRAPYDASH_PORT <<<>>> your SCRAPYD_SERVERS

GitHub: https://github.com/EmanueleCannizzaro0/scrapydash
DOCS: https://github.com/EmanueleCannizzaro0/files/blob/master/scrapydash/README.md
文档：https://github.com/EmanueleCannizzaro0/files/blob/master/scrapydash/README_CN.md
"""
import os
...
############################## QUICK SETUP start ##############################
############################## 快速设置 开始 ###################################
# Setting SCRAPYDASH_BIND to '0.0.0.0' or IP-OF-THE-CURRENT-HOST would make
...
# Visit https://github.com/EmanueleCannizzaro0/logparser for more info.
...
# raises any excepion at startup: https://github.com/EmanueleCannizzaro0/scrapydash/issues/18
ENABLE_HTTPS = False
...
# ]
# See https://github.com/EmanueleCannizzaro0/scrapydash/issues/94 for more info.
...
EMAIL_SUBJECT = 'Email from #scrapydash'
...
########## alert switcher ##########
# Tip: Set the SCRAPYDASH_BIND option the in "QUICK SETUP" section to the actual IP of your host,
...
# e.g. 'C:/Users/username/scrapydash_data' or '/home/username/scrapydash_data'
