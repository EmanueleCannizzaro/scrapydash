...
class ProjectsView(BaseView):
    ...
    def dispatch_request(self, **kwargs):
        ...
        # _bind = '127.0.0.1' if self.SCRAPYDASH_BIND == '0.0.0.0' else self.SCRAPYDASH_BIND
        # _url = 'http://{}:{}{}'.format(_bind, self.SCRAPYDASH_PORT, _url)
    ...
    def handle_status_error(self):
        if self.opt == 'listversions':
            ...
            return render_template('scrapydash/listversions_error.html', **kwargs)
        else:
            if self.POST:
    ...
    def listprojects(self):
        ...
        return render_template('scrapydash/projects.html', **kwargs)
    ...
    def listspiders(self):
        ...
        return render_template('scrapydash/listspiders.html', node=self.node, results=results)
    ...
    def listversions(self):
        ...
        return render_template('scrapydash/listversions.html', **kwargs)
