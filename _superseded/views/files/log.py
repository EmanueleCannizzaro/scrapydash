...
class LogView(BaseView):
    ...
    def __init__(self):
        ...
        if self.opt == 'report':
            ...
            self.template = 'scrapydash/%s%s.html' % (self.opt, '_mobileui' if self.USE_MOBILEUI else '')
    ...
    def set_email_content_kwargs(self):
        ...
        self.email_content_kwargs['url_stop'] = self.URL_SCRAPYDASH + _url_stop
    ...
    def send_alert(self):
        if (self.flag
            ...
            subject = u"{flag} [{pages}p, {items}i] {job_key} {latest_item} #scrapydash".format(**kwargs)
