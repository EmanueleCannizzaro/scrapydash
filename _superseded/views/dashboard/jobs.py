...
# See also scrapydash/utils/poll.py
...
class JobsView(BaseView):
    ...
    def __init__(self):
        ...
        if self.USE_MOBILEUI:
            self.style = 'classic'
            self.template = 'scrapydash/jobs_mobileui.html'
        elif self.style == 'classic':
            self.template = 'scrapydash/jobs_classic.html'
        else:  # 'database'
            self.template = 'scrapydash/jobs.html'
