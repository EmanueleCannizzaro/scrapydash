...
from ..__version__ import __version__ as SCRAPYDASH_VERSION
...
class BaseView(View):
    ...
    SCRAPYDASH_VERSION = SCRAPYDASH_VERSION
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.SCRAPYDASH_SETTINGS_PY_PATH = app.config['SCRAPYDASH_SETTINGS_PY_PATH']
        ...
        # ScrapydWeb
        self.SCRAPYDASH_BIND = app.config.get('SCRAPYDASH_BIND', '0.0.0.0')
        self.SCRAPYDASH_PORT = app.config.get('SCRAPYDASH_PORT', 5000)
        ...
        self.URL_SCRAPYDASH = app.config.get('URL_SCRAPYDASH', 'http://127.0.0.1:5000')
        ...
        self.EMAIL_SUBJECT = app.config.get('EMAIL_SUBJECT', '') or 'Email from #scrapydash'
        ...
        self.template_fail = 'scrapydash/fail_mobileui.html' if self.USE_MOBILEUI else 'scrapydash/fail.html'
        self.update_g()
    ...
    def safe_walk(self, top, topdown=True, onerror=None, followlinks=False):
        ...
        # ('top: ', u'/home/username/download/scrapydash/scrapydash/data/demo_projects/ScrapydWeb_demo')
