...
class SettingsView(BaseView):
    ...
    def __init__(self):
        ...
        self.template = 'scrapydash/settings.html'
    ...
    def update_kwargs(self):
        ...
        self.kwargs['SCRAPYDASH_SETTINGS_PY_PATH'] = self.handle_slash(self.SCRAPYDASH_SETTINGS_PY_PATH)
        ...
        self.kwargs['scrapydash_version'] = self.SCRAPYDASH_VERSION
        self.kwargs['scrapydash_server'] = self.json_dumps(dict(
            SCRAPYDASH_BIND=self.SCRAPYDASH_BIND,
            SCRAPYDASH_PORT=self.SCRAPYDASH_PORT,
            URL_SCRAPYDASH=self.URL_SCRAPYDASH,
