...
class DeployView(BaseView):
    ...
    def __init__(self):
        ...
        self.template = 'scrapydash/deploy.html'
    ...
    def set_scrapy_cfg_list(self):
        ...
        try:
            ...
            if PY2:
                ...
                raise
        # '/home/username/Downloads/scrapydash/scrapydash/data/demo_projects/\udc8b\udc8billegal/scrapy.cfg'
...
class DeployUploadView(BaseView):
    ...
    def __init__(self):
        ...
        self.url = ''
        self.template = 'scrapydash/deploy_results.html'
    ...
    def uncompress_to_tmpdir(self, filepath):
        ...
        tmpdir = tempfile.mkdtemp(prefix="scrapydash-uncompress-")
                ...
                if PY2:
                    ...
                    for filename in f.namelist():
                        ...
                        try:
                            ...
                            # temp\\scrapydash-uncompress-qrcyc0\\demo7/demo/'
