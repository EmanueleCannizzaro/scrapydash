...
class TaskExecutor(object):
    ...
    def __init__(self, task_id, task_name, url_scrapydash, url_schedule_task, url_delete_task_result,
                 auth, selected_nodes):
    ...
    def schedule_task(self, node):
        ...
        try:
            ...
            if node not in self.nodes_to_retry:
                ...
                js.setdefault('url', self.url_scrapydash)  # '127.0.0.1:5000'
    ...
    with db.app.app_context():
        ...
        if not task:
            ...
            task_executor = TaskExecutor(task_id=task_id,
                                         task_name=task.name,
                                         url_scrapydash=metadata.get('url_scrapydash', 'http://127.0.0.1:5000'),
